# stolen from https://stackoverflow.com/questions/11906925/python-simulate-keydown/11910555#11910555
...
def SendKey(code):
  SendInput(Keyboard(code))
  time.sleep(0.1)
  SendInput(Keyboard(code, KEYEVENTF_KEYUP))
